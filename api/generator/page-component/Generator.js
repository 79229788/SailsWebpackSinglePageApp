...
module.exports = {
  ...
  before: function (scope, cb) {
    ...
    scope.moduleFullName = `${scope.pageFullName}-component-${scope.moduleName}`;
   ...
   */
  targets: {
    './assets/javascript/views/:groupName/pages/:pageName/components/:moduleName.vue': { template: 'module.template.js' },
  },
